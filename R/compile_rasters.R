...
#' @returns A raster layer of population densities.
compile_rasters <- function(tileIDs, study_area, data_directory = "data", study_area_buffer = 1000){
  require("sf")
  require("raster")
  require("terra")
  require("stringr")
  ...
  out <- crop( r, raster::extent( st_bbox( st_buffer( study_area, dist = study_area_buffer) ) ) )
